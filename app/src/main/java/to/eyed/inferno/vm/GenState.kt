...
sealed interface GenState {
    ...
    /** A send was accepted while the engine was Loading/Suspended; dispatched automatically at Ready. */
    ...
    /** Reasoning tokens arriving, no visible answer yet. tokPerSec is an EMA published at 2 Hz. */
